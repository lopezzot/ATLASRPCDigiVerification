...
FILE_PATTERN = "I*.txt" # Pattern per trovare i file (es. rpc_signal_t*ns.txt)
                                   # Assicurati che il prefisso corrisponda!
OUTPUT_FILENAME = "I_animation.gif" # Nome file output (.gif o .mp4)
...
ax.set_xlabel("Strip position x (m)")
ax.set_ylabel("Current (A)")
fig.subplots_adjust(left=0.2)
ax.set_title("RPC current evolution")
